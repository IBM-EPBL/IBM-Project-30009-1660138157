...
COS_API_KEY_ID="ccUfUu7wchmGhs2v2K54PrwDPVdQWwLbL2UAKS1_6qVP"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/30f8cb8afbf947d98b7698ba787bd842:7acfab3e-50a1-422b-ab78-e59ab159f31b::"
...
@app.route('/')
def index():
    files = get_bucket_contents('varshasekhar')
