...
COS_API_KEY_ID="MfpS-pdgCaLDFxhcDDKK8brycFAIZClq10Ut0WoUdNRw"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/e6fec0155dfe4250adef724b58e6600c:099e0e03-741b-41f6-8ca4-bb9135ae42ae::"
...
@app.route('/')
def index():
    files = get_bucket_contents('vinisha17')
